...
public class JoinResponse extends BaseGroupIntegerResponse implements Response<JoinRequest> {
    private Code mCode;
    private JoinRequest mRequest;
    ...
    JoinResponse(final NodeId groupId, final Token groupToken, final Token sourceToken) {
    ...
    public MessageId getMessageId() {
        return MessageId.GROUP_JOIN_RESPONSE;
    }

    @Override
    public JoinRequest getOriginalRequest() {
        return mRequest;
    }

    @Override
    public void setOriginalRequest(final JoinRequest request) {
        mRequest = request;
    }
